    ...
    Scene1.init = function() {
      ...
      this.material2 = new THREE.MeshLambertMaterial( { map: ImageUtils.loadTexture( 'textures/minecraft/grass_dirt.png') } );

      this.material3 = new THREE.MeshLambertMaterial({ color: 0xFF0000, shading: THREE.SmoothShading });
      this.material4 = new THREE.MeshLambertMaterial( { color: 0xdddddd, shading: THREE.FlatShading } );
      ...
      this.plane = new THREE.Mesh(new Plane(1024,1024,16,16),this.material4);
    ...
    Scene1.keyPress = function(key) {
      if(key == 'space') {
        Voxel(Math.random()*5,this.material2).pos(Math.random()*1024 - 512,
        2048,
